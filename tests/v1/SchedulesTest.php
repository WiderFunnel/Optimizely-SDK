...
class SchedulesTest extends TestCase
{
    ...
    public function it_can_fetch_the_list_of_schedules_in_an_experiment()
    {
        ...
        $this->assertInstanceOf(\WiderFunnel\Collections\ScheduleCollection::class, $schedules);
        $this->assertObjectHasAttribute('items', $schedules);
        $this->assertInstanceOf(\WiderFunnel\Items\Schedule::class, $schedules->first());
    ...
    public function it_can_fetch_a_schedule()
    {
        ...
        $this->assertInstanceOf(\WiderFunnel\Items\Schedule::class, $schedule);
